...
export function timelineEventForPersistence(value: unknown): PersistedTimelineEvent | undefined {
  ...
  const linkedAgentProjectName = stringValue(event.linkedAgentProjectName);
  const linkedAgentSessionId = stringValue(event.linkedAgentSessionId);
  ...
  if (linkedAgentProjectName) out.linkedAgentProjectName = linkedAgentProjectName;
  if (linkedAgentSessionId) out.linkedAgentSessionId = linkedAgentSessionId;
