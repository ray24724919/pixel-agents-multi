...
export const PROJECT_ROOM_LOBBY_LOUNGE_MIN_DECOR = 3;
export const PROJECT_ROOM_LOBBY_LOUNGE_MAX_DECOR = 6;
export const PROJECT_ROOM_LOBBY_LOUNGE_TILES_PER_DECOR = 45;
...
export const PROJECT_ROOM_GENERATED_DOORWAY_WIDTH = 2;
