...
export const PROJECT_ROOM_WORK_CORRIDOR_MIN_WIDTH = 21;
...
export const PROJECT_ROOM_STANDARD_REST_SEAT_OFFSET_ROW = 5;
...
export const PROJECT_ROOM_COLLAB_REST_SEAT_OFFSET_ROW = 5;
