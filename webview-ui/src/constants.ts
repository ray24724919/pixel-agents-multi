...
export const PROJECT_ROOM_DOORPLATE_MAX_CHARS = 18;
export const PROJECT_ROOM_DOORPLATE_MIN_ZOOM = 1;
export const PROJECT_ROOM_DOORPLATE_FONT_PX = 5;
export const PROJECT_ROOM_DOORPLATE_PADDING_X_PX = 2;
export const PROJECT_ROOM_DOORPLATE_PADDING_Y_PX = 1;
export const PROJECT_ROOM_BOUNDARY_LINE_WIDTH_PX = 1;
export const PROJECT_ROOM_DEFAULT_WIDTH = 10;
export const PROJECT_ROOM_DEFAULT_HEIGHT = 8;
...
export const PROJECT_ROOM_COLLAB_TEMPLATE_MIN_WIDTH = 10;
export const PROJECT_ROOM_COLLAB_TEMPLATE_MIN_HEIGHT = 8;
export const PROJECT_ROOM_COLLAB_TABLE_OFFSET_COL = 4;
export const PROJECT_ROOM_COLLAB_TABLE_OFFSET_ROW = 2;
export const PROJECT_ROOM_COLLAB_LEFT_CHAIR_OFFSET_COL = 3;
export const PROJECT_ROOM_COLLAB_RIGHT_CHAIR_OFFSET_COL = 7;
export const PROJECT_ROOM_COLLAB_LEFT_PC_OFFSET_COL = 4;
export const PROJECT_ROOM_COLLAB_RIGHT_PC_OFFSET_COL = 6;
export const PROJECT_ROOM_COLLAB_TOP_ROW_OFFSET = 2;
export const PROJECT_ROOM_COLLAB_BOTTOM_ROW_OFFSET = 4;
