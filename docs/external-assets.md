...
Pixel Agents Multi supports loading furniture assets from directories outside the extension. This lets you use custom or third-party pixel art asset packs alongside the built-in furniture.

## Adding an External Directory

1. Open the Pixel Agents Multi panel and click **Settings**
...
4. The directory path is saved to `~/.pixel-agents-multi/config.json` and reloaded automatically on restart
